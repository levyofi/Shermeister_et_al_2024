...
DATA_PATH = "/data/lizard_classification_model/training_data/Ben/color_August_2022" #"/data/lizard_classification_model/training_data/Ben/color/"
...
neg_datapath = Path("/data/lizard_classification_model/training_data/Ben/color_August_2022/negative")
...
for i in range(0,20):
    ...
    data = (ImageList.from_folder(datapath)
            ...
            .normalize(imagenet_stats))
    print(data.batch_stats)
    learn.save("/data/lizard_classification_model/lizard_model_color_ben_August"+str(i)+"_"+f"{acc:4.2f}")
    learn.export("/data/lizard_classification_model/lizard_model_color_ben__August"+str(i)+"_"+f"{acc:4.2f}"+".pkl")
