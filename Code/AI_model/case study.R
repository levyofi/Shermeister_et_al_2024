...
setwd("D:/OfirL6/Documents/Ben/")

ibuttons_data<-fread("Ben's ibuttons data/enclosures' ibuttons/second year relevant data/all_data_ibuttons_second_year.csv")
meteo_data<-fread("zoo garden meteorological station/all_data_meteo_SECOND_YEAR.csv")

model_data_07.05<-fread("enclosures_exp/encexp/model_confidence_07.05.ALL_IMAGES_07.11.22.csv")
...
colnames(model_ibutton_meteo)[8]<-"shaded"
...
manual_07.05<-fread("enclosures_exp/encexp/lizard_detections_validation_07.05.2022_FOR_MODEL.csv")
